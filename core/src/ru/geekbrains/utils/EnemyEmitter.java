...
public class EnemyEmitter {
    ...
    private static final float ENEMY_SMALL_TIME_MAX_ANIMATION = 0.04f;
    ...
    private static final float ENEMY_MEDIUM_TIME_MAX_ANIMATION = 0.05f;
    ...
    private static final float ENEMY_BIG_TIME_MAX_ANIMATION = 0.08f;
        ...
        if (generateTimer >= generateInterval) {
            ...
            if (type < 0.5f) {
                enemy.set(
                        ...
                        ENEMY_SMALL_HP,
                        ENEMY_SMALL_HEIGHT,
                        ENEMY_SMALL_TIME_MAX_ANIMATION
                );
            } else if (type < 0.8f) {
                enemy.set(
                        enemyMediumRegion,
                        ...
                        ENEMY_MEDIUM_HP,
                        ENEMY_MEDIUM_HEIGHT,
                        ENEMY_MEDIUM_TIME_MAX_ANIMATION
                );
            } else {
                enemy.set(
                        enemyBigRegion,
